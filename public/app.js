...
const INITIATIVES = [
  ...
  { icon:'🏛️', kind:{en:'National Framework', ar:'إطار وطني'},
    t:{en:'Sudan Cybersecurity Authority (SCA)', ar:'هيئة الأمن السيبراني السودانية (SCA)'},
    d:{en:'The Sudan National Cybersecurity Framework (SNCF): a national baseline of governance, risk management and protection controls for government and critical sectors, developed under the supervision of the SCA.',
       ar:'إطار السودان الوطني للأمن السيبراني (SNCF): خط أساس وطني للحوكمة وإدارة المخاطر وضوابط الحماية في القطاع الحكومي والقطاعات الحيوية، طُوّر تحت إشراف هيئة الأمن السيبراني السودانية.'},
    g:{en:['Governance','Critical Infrastructure','National'], ar:['حوكمة','بنية تحتية حيوية','وطني']},
    o:{en:'Five national frameworks and seven control families, each with maturity levels and implementation guidance aligned to international standards.',
       ar:'خمسة أطر وطنية وسبع مجموعات ضوابط، لكل منها مستويات نضج وإرشادات تنفيذ متوافقة مع المعايير الدولية.'} },
  ...
  { icon:'📍', kind:{en:'In Development', ar:'قيد التطوير'},
    t:{en:'PIOS: Place Intelligence Operating System', ar:'PIOS: نظام تشغيل الاستخبارات المكانية'},
    d:{en:'An Arabic-first, trust-driven location intelligence platform that answers one question for every user: what is the best option for me, in this context, and why?',
       ar:'منصة استخبارات مكانية عربية أولاً ومبنية على الثقة، تجيب عن سؤال واحد لكل مستخدم: ما الخيار الأفضل لي في هذا السياق، ولماذا؟'},
    g:{en:['Location Intelligence','Arabic-First','Saudi Launch'], ar:['استخبارات مكانية','عربية أولاً','إطلاق سعودي']},
    o:{en:'Context-aware discovery, multi-source evidence with provenance, and explainable ranking built on trust rather than star ratings, launching in Riyadh and Jeddah.',
       ar:'اكتشاف مدرك للسياق، وأدلة متعددة المصادر ذات منشأ موثّق، وترتيب قابل للتفسير مبني على الثقة لا على تقييمات النجوم، مع إطلاق في الرياض وجدة.'} },
  { icon:'🗺️', kind:{en:'Market Intelligence', ar:'استخبارات سوق'},
    t:{en:'LEAP 2026 Directory', ar:'دليل LEAP 2026'},
    d:{en:'A bilingual directory platform mapping all 1,475 LEAP 2026 exhibitors into ten sectors with hall and booth detail, search and export.',
       ar:'منصة دليل ثنائية اللغة ترسم خريطة شركات معرض LEAP 2026 البالغ عددها 1,475 شركة، مصنّفة في عشرة قطاعات مع تفاصيل القاعات والأجنحة والبحث والتصدير.'},
    g:{en:['LEAP 2026','Riyadh','Open Data'], ar:['LEAP 2026','الرياض','بيانات مفتوحة']},
    o:{en:'Arabic and English descriptions for every exhibitor, intelligent categorisation and CSV, Excel and JSON export for analysis.',
       ar:'وصف عربي وإنجليزي لكل شركة عارضة، وتصنيف ذكي، وتصدير بصيغ CSV و Excel و JSON للتحليل.'} },
...
const TIMELINE = [
  { date:{en:'2023 - Present', ar:'2023 - حتى الآن'}, role:{en:'Founder / CEO', ar:'المؤسس والرئيس التنفيذي'},
    ...
    current:true },
  { date:{en:'2023 - 2026', ar:'2023 - 2026'}, role:{en:'Operations Manager', ar:'مدير العمليات'},
    org:{en:'Wed Najd for Logistics Services · Riyadh, Saudi Arabia', ar:'ود نجد للخدمات اللوجستية · الرياض، السعودية'},
    d:{en:'Directed end-to-end logistics operations across transportation, warehousing, inventory and order fulfilment. Led the operations team, negotiated vendor and 3PL contracts, owned the logistics budget, and ran the KPI cycle on on-time delivery, order accuracy and inventory turnover. Drove process optimisation and automation while keeping operations compliant with local and international supply-chain regulation.',
       ar:'قيادة عمليات لوجستية متكاملة تشمل النقل والتخزين وإدارة المخزون وتنفيذ الطلبات. إدارة فريق العمليات، والتفاوض على عقود المورّدين ومزوّدي الخدمات اللوجستية، وإدارة الموازنة التشغيلية، ومتابعة مؤشرات الأداء في الالتزام بمواعيد التسليم ودقة الطلبات ودوران المخزون. تحسين العمليات وأتمتتها مع ضمان الالتزام باللوائح المحلية والدولية لسلاسل الإمداد.'} },
