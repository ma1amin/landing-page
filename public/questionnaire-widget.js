...
(function (window, document) {
  ...
  var TEXT = {
    ...
    eyebrow:     { en: "PARTNER MATCHING / 90 SECONDS", ar: "مطابقة الشركاء · 90 ثانية" },
    title:       { en: "Looking for the right <span>partner?</span>",
                   ar: "تبحث عن <span>الشريك المناسب؟</span>" },
    description: { en: "Ten short questions, about ninety seconds. I use your answers to introduce you to the right technical or executive partner from my network.",
                   ar: "عشرة أسئلة قصيرة تستغرق نحو تسعين ثانية. أستخدم إجاباتك لأعرّفك على الشريك التقني أو التنفيذي المناسب من شبكتي." },
    points:      { en: ["Ten questions", "About 90 seconds", "No obligation", "Introductions only"],
                   ar: ["عشرة أسئلة", "نحو 90 ثانية", "دون أي التزام", "تعارف فقط"] },
    ctaLabel:    { en: "Start the questionnaire",   ar: "ابدأ الاستبيان" },
    footnote:    { en: "Introductions only · Answers reach me directly",
                   ar: "تعارف فقط · تصلني إجاباتك مباشرة" },
    arrow:       { en: "\u2192",                    ar: "\u2190" }
  };
